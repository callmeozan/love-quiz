...
const questions = [
    ...
    { text: "Saya memiliki hubungan yang hangat dengan pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/4.png', 'assets/5.png']}, //question1
    // { text: "Kalau aku lagi down, pasangan selalu jadi charger emosiku.", dimension: 'intimacy', type: 'likert', images: ['assets/2.png'] },
    { text: "Saya menerima dukungan secara emosional dari pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/2.png'] },
    // { text: "Pasangan itu kayak VIP di hidupku, nomor satu di hati.", dimension: 'intimacy', type: 'likert', images: ['assets/3.png'] },
    { text: "Saya sangat menghargai kehadiran pasangan dalam hidup saya.", dimension: 'intimacy', type: 'likert', images: ['assets/3.png'] },
    ...
    { text: "Saya memiliki hubungan yang hangat dan saling mendukung dengan pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/13.png'] },
    // { text: "Dia ngerti aku bahkan tanpa aku ngomong banyak.", dimension: 'intimacy', type: 'likert', images: ['assets/6.png'] },
    { text: "Saya merasa benar-benar dipahami oleh pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/6.png'] },
    ...
    { text: "Saya merasa pasangan saya adalah pribadi yang sangat menarik.", dimension: 'passion', type: 'likert', images: ['assets/1.png'] },
    { text: "Saya tak bisa membayangkan orang lain mampu membahagiakan saya seperti yang pasangan lakukan.", dimension: 'passion', type: 'likert', images : ['assets/9.png', 'assets/10.png'] },
    // { text: "Nggak ada orang lain yang bisa bikin aku se-happy ini.", dimension: 'passion', type: 'likert', images: ['assets/8.png'] },
    { text: "Saya memiliki hubungan yang 'ajaib' dengan pasangan.", dimension: 'passion', type: 'likert', images: ['assets/15.png'] },
    ...
    { text: "Saya memiliki hubungan yang penuh gairah dengan pasangan.", dimension: 'passion', type: 'likert', images: ['assets/2.png'] },
    ...
    { text: "Saya yakin hubungan dengan pasangan akan berjalan baik-baik saja.", dimension: 'passion', type: 'likert', images: ['assets/11.png'] },
    { text: "Saya memandang komitmen terhadap pasangan adalah hal yang penting.", dimension: 'commitment', type: 'likert', images : ['assets/13.png']},
    // { text: "Komitmenku ke pasangan kuat banget, kayak password 16 karakter.", dimension: 'commitment', type: 'likert', images: ['assets/14.png'] },
    { text: "Saya yakin mencintai pasangan seutuhnya.", dimension: 'commitment', type: 'likert', images: ['assets/3.png'] },
    // { text: "Aku yakin banget sama cintaku ke dia, no doubt.", dimension: 'commitment', type: 'likert', images: ['assets/11.png'] },
    { text: "Saya melihat hubungan dengan pasangan sebagai suatu yang tetap untuk selamanya.", dimension: 'commitment', type: 'likert', images: ['assets/11.png'] },
    // { text: "Buatku, hubungan ini bukan sementara — ini long-term plan.", dimension: 'commitment', type: 'likert', images: ['assets/12.png'] },
    { text: "Saya memiliki rasa tanggung jawab terhadap pasangan.", dimension: 'commitment', type: 'likert', images: ['assets/12.png'] },
