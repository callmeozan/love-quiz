...
const questions = [
    ...
    { text: "Saya memiliki hubungan yang hangat dengan pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/1.png']},
    ...
    { text: "Saya memiliki hubungan yang hangat dan saling mendukung dengan pasangan.", dimension: 'intimacy', type: 'likert', images: ['assets/4.png', 'assets/5.png'] },
    ...
    { text: "Saya merasa pasangan saya adalah pribadi yang sangat menarik.", dimension: 'passion', type: 'likert', images: ['assets/7.png'] },
    // { text: "Pilih emoji yang paling pas menggambarkan gairah di hubungan kalian:", dimension: 'passion', type: 'emoji', options: ['❄️', '💧', '😊', '🔥', '💥'] },
    { text: "Saya tak bisa membayangkan orang lain mampu membahagiakan saya seperti yang pasangan lakukan.", dimension: 'passion', type: 'emoji', options: ['❄️', '💧', '😊', '🔥', '💥'] },
    ...
    { text: "Saya memiliki hubungan yang penuh gairah dengan pasangan.", dimension: 'passion', type: 'likert', images: ['assets/15.png'] },
    ...
    { text: "Saya memandang komitmen terhadap pasangan adalah hal yang penting.", dimension: 'commitment', type: 'emoji', options: ['🤔', '📝', '🤝', '🔒', '💍'] },
